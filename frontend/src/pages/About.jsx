...
function About() {
  return (
    ...
    <div class="bg-white">
      <header class="bg-slate-500 text-white text-center py-12">
      ...
      <section class="bg-slate-500 text-white py-12 px-4">
      ...
      <section class="text-center py-12 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-8">
          <div class="p-4 shadow-lg rounded-lg bg-slate-100 hover:bg-slate-200 transition-colors">
      ...
      <section class="bg-slate-500 text-white text-center py-12 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 max-w-5xl mx-auto">
          <div class="p-4 shadow-lg rounded-lg bg-slate-600 hover:bg-slate-500 transition-colors">
      ...
      <footer class="bg-slate-500 text-white text-center py-8">
        <p>&copy; Copyright Rudra Gupta . All rights reserved. Made By Binary Boats⛵</p>
      </footer>
    </div>
    </div>
    <Footer />
